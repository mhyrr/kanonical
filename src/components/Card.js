...
export const Card = styled.div`
  background: linear-gradient(to bottom, ${props => props.type == 'link' ? 'rgba(218, 176, 161, .8)' : (props.type == 'quote' ? 'rgba(116, 164, 195,  .8)' : 'rgba(255, 156, 122, .8)')} 0%,rgba(255,255,255,.4) 100%);
