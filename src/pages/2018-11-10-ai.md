...
Like, a really huge amount of data.  Even with a steady and very high bandwidth input process, it will take years of data. Furthermore, the data most be both supervised and unsupervised for best results.  While repetition can be incredibly valuable sometimes, only feeding in the same old datasets over and over just won't do either.  
