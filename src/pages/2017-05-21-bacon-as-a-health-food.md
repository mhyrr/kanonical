...
date: 2017-05-21T01:39:14.000Z
path: /2017-05-21-bacon-as-a-health-food/
---

So recently.. this happened:

<blockquote class="instagram-media" data-instgrm-captioned data-instgrm-version="7" style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:658px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);"><div style="padding:8px;"> <div style=" background:#F8F8F8; line-height:0; margin-top:40px; padding:50.0% 0; text-align:center; width:100%;"> <div style=" background:url(data:image/png;base64,); display:block; height:44px; margin:0 auto -44px; position:relative; top:-22px; width:44px;"></div></div> <p style=" margin:8px 0 0 0; padding:0 4px;"> <a href="https://www.instagram.com/p/BUMVNBWl0p3/" style=" color:#000; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none; word-wrap:break-word;" target="_blank">Not the usual post (can&#39;t believe I put this on IG), but I&#39;m pretty proud of getting up and doing something. Down 35 lbs in 11 weeks. There&#39;s more muscle everywhere, I feel better, I sleep better, and I think better. The pics are 9 weeks apart.  Things I&#39;ve learned: Bacon is a health food.  It&#39;s all in your head.  We can make excuses so easily.  Diet makes you look good in clothes.  Exercise makes you look good naked.  Not done yet, but another 12 weeks should do it!  #keto #bacon #skwaaats #deadlift #bench</a></p> <p style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;">A post shared by Greg (@mhyrr) on <time style=" font-family:Arial,sans-serif; font-size:14px; line-height:17px;" datetime="2017-05-17T12:00:18+00:00">May 17, 2017 at 5:00am PDT</time></p></div></blockquote>
...
* The Only Two Things That Matter For Losing Weight
* Lose Weight On One Week of Willpower
* Lose Weight Eating Foods You Love
* Eat Less, Move More
- The Value of Being Sore
...
- It better regulates your insulin
- After you adapt, it makes you much less hungry (appetite suppression)
- It forces your body to look for a different energy source.  And so your body makes [ketones](https://en.wikipedia.org/wiki/Ketone_bodies) from fatty acids.  This is where the term ketosis comes from.
- It reduces your blood pressure
- Since you're eating less because you're not hungry, your body starts looking for other ways to produce it's new ketone energy source, and it starts harvesting your fat stores
...
The physicist in me - which usually wins - says that of course it's a straight energy equation and calorie counting is the only thing that matters<sup>[2](#math)</sup>.  The biochemist in me says that of course the body regulates and manages the energy supply it gets and uses it in different ways.  There are studies on both sides, and I really don't want to have to care too much about an incredibly complex biological process like the conversion of sunlight to edible plants/animals to human energy.

The thing I really like about keto is that it covers all the bases.

See, a keto diet does an incredible job at regulating your insulin cycle and forcing your body into a state where it's used to dealing with very little sugar.  It responds by producing these ketone things from your fat stores.  So there's quite a lot of [chemical trickery](https://www.ruled.me/ketosis-ketones-and-how-it-works/) going on.
...
Once that's set, just get going. Start. Especially at first, having a schedule of a few simple meals that you enjoy will make it super easy to follow.  For the first week or so, use MyFitnessPal or a similar app to track your calories and the amount of fat you're getting.  It's actually hard to get 70-80% fat!  If you get too much protein, your body will end up [producing glucose from the protein](https://en.wikipedia.org/wiki/Gluconeogenesis) and you won't enter the state of ketosis.

Here's what worked for me:

* **Breakfast**
  * Tea with stevia and heavy cream.  Coffee works too.
  * 3-4 Eggs, maybe with some shredded cheese or spinach
  * Sausage or bacon.  Omg bacon is delicious.
* **Lunches**
  * Leftover dinner stuff
  * Salad (spinach, green lettuce or 50/50 mix) with a fatty vinaigrette and cheese
* **Dinner**
  * A meat and a veggie.  
* **Snacks**
  * String cheese
  * Cheese and Crackers (without the crackers)
  * Salted peanuts or cashews
  * Jerky
* **Other Rules**
  * Water, water, water.  Over 2L of water a day.  I get a new bottle of Smart Water every day because they have electrolytes, which you'll need.
  * I cut out soda completely for the first 8 weeks or so.  I'm only drinking water, carbonated water (Perrier, to replace soda), tea, red wine, whiskey on the weekends.  
  * Even when you bring soda back, diet soda only.  I don't think diet soda is a problem, but I do think it limits the amount of water you drink.  And, for me, the more water I drink, the easier the weight comes off.
  * No sugar or artificial sweeteners.  We have Stevia now, which is the only sweetener that actually doesn't produce an insulin response.
  * Get the 80/20 ground beef.  Not only does it fit the diet better, it also tastes better.
  * Fatty meats or fish are best.  Sausage, pork, steak, salmon.  If you get chicken, make sure you get enough fat.
  * Full fat butter, heavy cream, full fat sour cream, full fat cream cheese, etc. 
  * No bread or pasta or starch
  * Don't eat after about 7p (or within 3 hours of bedtime).
  * Use an Omega 3 supplement - I use krill oil (no aftertaste)
  * Get enough salt (again, counterintuitive, but you're drinking so much water that you'll need it)
* **"Cheat" Tips**
  * I am a pizza fanatic, so this was one of the biggest sacrifices.  Fortunately, [Fathead Pizza](http://www.ditchthecarbs.com/2015/04/23/fat-head-pizza/) is absolutely fantastic.  I had this probably once a week and loved it.
  * Just make the fathead pizza dough and cut it into square slices for "crackers".  Eat with cheese or make a sour cream dip.
  * [The Great Low Carb Bread Company](http://www.greatlowcarb.com/) makes great cinnamon bagels, hamburger rolls and hotdog rolls.  
  * Pan fried mozzarella-based gnocchi is delicious.
  * Basically, find things you enjoy.. and eat them.  Use [good resources](https://www.dietdoctor.com/how-to-lose-weight) 
 with [delicious recipes](http://www.ruled.me/guide-keto-diet/#).  That way, you won't feel like you have to cheat.
...
When most people start trying to get into shape, they start running.  So let's get this out of the way.. you shouldn't run<sup>[3](#hiit)</sup>.

There's only two kinds of people that should run:

1. Runners.  Some people just love to run.  If you're in the camp where you love it enough to do it many times a week.. then this whole article probably doesn't apply to you.
2. Very competitive people.  If you're determined to compete and this is an outlet for you, then fine.  But there's plenty of other outlets.

Now, why shouldn't you run?  Lots of reasons - it can be boring, it's hard on your joints.. but the biggest reason is that [you won't get the results you want](http://www.shape.com/weight-loss/tips-plans/5-reasons-running-may-not-help-you-lose-weight).

Let's compare:
![Yeah, no thanks running](https://impossiblehq.com/wp-content/uploads/2012/08/MARATHONSPRINT.jpg)
...
Which is basically what powerlifting is - lifting heavy weights and focusing on the 3 big movements - the squat, the deadlift, the bench press.  These three exercises are the kings of the gym<sup>[4](#oly)</sup>, the best overall movements you can do to build your body and all of your muscles.  Want the best exercise for abs?  That would be the squat.  Second best?  Deadlift.  Best for legs?  Squat.  Second?  Deadlift.
...
![Big guy](http://i.imgur.com/Gjfz5jd.jpg)
...
![The best around, they don't ab roll](https://i.ytimg.com/vi/v9ywhy0x7G4/maxresdefault.jpg)

Need something more realistic?  How about Jesse Norris, one of the best at 198 lbs.

![Freakin strong](http://www.greatestphysiques.com/wp-content/uploads/2017/03/8-9.jpg)
...
<blockquote class="instagram-media" data-instgrm-captioned data-instgrm-version="7" style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:658px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);"><div style="padding:8px;"> <div style=" background:#F8F8F8; line-height:0; margin-top:40px; padding:62.5% 0; text-align:center; width:100%;"> <div style=" background:url(data:image/png;base64,); display:block; height:44px; margin:0 auto -44px; position:relative; top:-22px; width:44px;"></div></div> <p style=" margin:8px 0 0 0; padding:0 4px;"> <a href="https://www.instagram.com/p/BVPwu0ZhqTL/" style=" color:#000; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none; word-wrap:break-word;" target="_blank">HAPPY MONDAY PEEPS ☀️🌷 Back at it again with the kitchen mirror selfies 😂😂 but this time super happy because 1. COFFEE. ☕️ 2. I had an awesome weekend seeing my bf who lives 467 miles away from me 😭✈️ 3. Officially 4 weeks out from my first @usapowerlifting meet!! I&#39;ve already made weight as I&#39;ve been fluctuating between 136-138 lbs while still training hard and eating all my favorite foods even harder 💪🏽🍳🍌🍕🍣</a></p> <p style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;">A post shared by Joy Sun (@liftwithjoy) on <time style=" font-family:Arial,sans-serif; font-size:14px; line-height:17px;" datetime="2017-06-12T16:29:57+00:00">Jun 12, 2017 at 9:29am PDT</time></p></div></blockquote> <script async defer src="//platform.instagram.com/en_US/embeds.js"></script>

<blockquote class="instagram-media" data-instgrm-captioned data-instgrm-version="7" style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:658px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);"><div style="padding:8px;"> <div style=" background:#F8F8F8; line-height:0; margin-top:40px; padding:50.0% 0; text-align:center; width:100%;"> <div style=" background:url(data:image/png;base64,); display:block; height:44px; margin:0 auto -44px; position:relative; top:-22px; width:44px;"></div></div> <p style=" margin:8px 0 0 0; padding:0 4px;"> <a href="https://www.instagram.com/p/BSPGgVAhDj3/" style=" color:#000; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none; word-wrap:break-word;" target="_blank">#Repost @g_activept ・・・ CARDIO vs WEIGHTS This is the theory - The human body naturally burns more calories each day to maintain a pound of muscle than it does to maintain a pound of fat. Therefore, the more muscle you build, the more calories your body will naturally burn each day at rest #winning _________________________________ I found the picture on the left from 2 yrs ago straight after I completed the ironman. My training consisted of 2 hrs+ of cardio a day and I hadn&#39;t lifted a weight in my life. I had no definition or muscle tone 😨 nearly 2 yrs on, this is me now (all be it my tan may be a little umpa lumpa-ish) but I&#39;ve got a lot more definition and size 🙌🏼 A lot of my clients say to me &#39;will this make me big and bulky&#39; when I get them to lift any kind of weight. I always reply with something along the lines of &#39;unless you are injecting steroids into your butt, then no!!&#39; 🤦🏼‍♀️ It takes a lot of time and considerable hard work for females to build muscle, you won&#39;t &#39;look like a man&#39; after lifting one weight! I&#39;ve been lifting for over a year and I much prefer my physique now even if I am a bit &#39;bulkier&#39; 🤷🏼‍♀️ #lovetolift #cardiovsweights #misconception #girlswholift #burncalories #liftweightstoburnfat #teamacf #transformation #beforeandafter</a></p> <p style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;">A post shared by Ashley Crooks || #teamACF (@ashleycrooksfitness) on <time style=" font-family:Arial,sans-serif; font-size:14px; line-height:17px;" datetime="2017-03-29T20:46:47+00:00">Mar 29, 2017 at 1:46pm PDT</time></p></div></blockquote> <script async defer src="//platform.instagram.com/en_US/embeds.js"></script>

So head to the gym and focus on the big barbell movements.  Especially when you start out and the weights aren't that heavy, you can squat every workout.  Find a good program that focuses on the big barbell movements, and add in some accessories near the end of the workout.  CrossFit is another great place to start<sup>[5](#crossfit)</sup>.  I started out using [Jason Blaha's Ice Cream 5x5 Novice Program](https://www.muscleandstrength.com/workouts/jason-blaha-ice-cream-fitness-5x5-novice-workout).  I'm a pretty strong guy and it worked great for months.  When you get started, make sure to learn proper form and then push the weights - in that order!  Learn the [RPE scale](https://my.clevelandclinic.org/health/articles/rpe-scale-heart-health) and how to use it - your sets should be in the RPE 6-8 scale for the most part.  Plan on spending 3-5 hours a week at the gym; about 60-90 minutes per workout.  Get plenty of rest too.  It should be hard and you should be sore.
...
And speaking of motivation, [you](https://www.youtube.com/watch?v=x5xXsdWRaFw) [should](https://www.youtube.com/watch?v=s86DJ1pVF0U) [definitely](https://www.youtube.com/watch?v=v9ywhy0x7G4) [get](https://www.youtube.com/watch?v=JvBgWzzBlR8) [some](https://www.youtube.com/watch?v=XNOMmmf8eWs).
...
A big chunk of personal trainers out there are junk.  The ones at most commercial gyms are junk.  Their purpose is to teach novices how not to get injured<sup>[6](#hurt)</sup> and to inject motivation into the workout.  But look.. if this is going to work, the motivation has to come from you, not from someone else.  It still probably does take someone else to help diagnose your weaknesses, your problems with form, answer questions, and to come up with programming that will push you without overdoing it.

The nice thing these days is that the internet enables you to find someone good wherever you are.  I found [my coach](http://www.whitneysp.com/) on Instagram, and [he is awesome](https://www.instagram.com/ct_whitney/).  [He's the kind of coach](http://www.whitneysp.com/testimonials.html) you should get.  I post videos to track progress and I get suggestions, criticism, and kudos.  I ask questions and get answers the same day, all the time.  And he leads by example, and works as hard or harder himself than all of his clients.  

And that's your motivation.  Find someone better than you and emulate them.  Stop making excuses - and there can be so many made so easily -
 and just start.  Wherever you are, just start. 
...
*1.* <a name="friends"></a>8 or 9 of my friends have done this same diet over the last few months and all of them have had similar success, losing 20-30 lbs.

*2.* <a name="math"></a>You should totally watch [this talk](https://www.youtube.com/watch?v=vuIlsN32WaE) which describes the math and chemistry behind weight loss.  I was amazed to find that, when I burn fat, it exits the body as 80% CO<sub>2</sub> I breathe out and 20% H<sub>2</sub>O I pee out.

*3.* <a name="hiit"></a>You can definitely do cardio for weight loss.  You just shouldn't do it in place of lifting weights.  If you're already lifting 3 or more times a week, then adding [HIIT and LISS](http://www.simplyshredded.com/cardio-for-fat-loss-high-intensity-interval-training-cardio-vs-low-intensity-steady-state-cardio.html) into your routine will do amazing things.  HIIT stands for High Intensity Interval Training - 30-60 second sprints with rests in between is one example.  LISS is Low Intensity Steady State cardio - just going for a pleasant morning walk.

*4.* <a name="oly"></a>There's another gym route to take, possibly even better than powerlifting, and that's olympic lifting.  The two main lifts here are the snatch and the clean & jerk.  They require all the same core, leg, and major muscle group strength as powerlifting while adding much more flexibility and balance.  If you're starting from scratch, this may be the best route.

*5.* <a name="crossfit"></a>CrossFit is an awesome way to get started.  Where it fails is by making novices think that a WOD by itself will get them where they want to be.  A lot of people see the CrossFit athletes on TV and think that their 20 minute workout is enough.  It isn't.  You need to spend some more time in the gym to move the needle.

*6.* <a name="hurt"></a>It's pretty important to be able to avoid injury.  As the weights have gotten heavier, I've had to learn how to focus more on mobility and flexibility.  A complete novice probably should have at least some in person training to get the gist of what's going on.  CrossFit gyms can excel here.