...
Welcome to my pseudonymous home.  This is the name you'll see.  I still have the old personal site (it’s the same repo, and I can `git push` from two separate branches for deploys).  The point is: one will be connected to whatever else I do on the Internet and one will not.
