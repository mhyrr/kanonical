...
The _real_ use of the word Malthusian ought to be for the extrapolation of data forward without change.  He saw something that looked exponential and applied the future as fact.  But [exponentials](/exponentials/) have funny properties, and things we often think of as exponential are actually sigmoids.  They rise rapidly for awhile, then start to asymptote out to some linear or fixed growth rate.
