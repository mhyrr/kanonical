...
There's still plenty of conversation to have about what's urgent vs. what's important. These sorts of tradeoffs are crucial, but the idea of waiting until the last minute helps determine whether _you need to plan at all!_ It shifts the focus from _what_ to play to _whether_ to plan. We usually slipside into the former without considering the former.

Which is the main point. The phrase "If you wait until the last minute, it only takes one minute" is actually a corollary to [Parkinson's Law](https://en.wikipedia.org/wiki/Parkinson%27s_law):
