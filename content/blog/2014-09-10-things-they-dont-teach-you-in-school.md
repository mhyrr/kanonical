...
So I have four different subjects for you today that, in my experience, were undervalued in school but very important in the real world.  I borrowed each of these four subjects from one of my personal heroes: [Freeman Dyson](http://en.wikipedia.org/wiki/Freeman_Dyson).
...
For all of these tools, mastery takes years.  There's an article out there called "[Learn Emacs in Ten Years](http://edward.oconnor.cx/2009/07/learn-emacs-in-ten-years)".  I've watched people edit text in ways that aren't even possible in more normal tools so quickly and easily that I decided to switch my toolset on the spot.  When you watch someone really good use these tools, after you pick your chin up off the floor, you realize it's worth the time to learn them.
