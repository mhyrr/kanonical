...
I was talking with a friend about all the things we want to do with our lives. We both have a nice long list and we were thinking about how to accomplish them. I believe strongly that the big difference between the rich and the poor is the ability to change and shape the world as you see fit. This is what wealth can purchase and it’s the big reason why I think [generating wealth is The Best Option](/the-options/). I’m intoxicated by my own ideas and so most of my list looks like a bunch of company ideas and products that should exist, sprinkled with some book-writing ideas.

But then he pointed out something. He said, “Greg, there’s no charity that you really believe in on here. Where do you want to make a bigger impact in the world? Maybe we should start there.”

I cycled through a few reactions.
1. Shit, I’m an asshole.
2. No you don’t understand what I’m saying! So I started writing a scree about why his point is wrong. After writing it, I realized that..
3. Clearly _I_ don’t understand either.

And here I am, trying to reason out my beef with charity. Because I do have some beef, and I think it’s valid.

But before we get to that, let's go through some different ideas that we'll try to interlock together.
...
But this is a poor model for reality. We don't simply see the pieces, manuever them, and outsmart anyone else. Rather, we take risks, make bets, leverage luck, and read the people around us. And if we do all that perfectly, we _still_ might lose!
...
So I’m going to cross that quadrant off. I’m sure there’s diamonds somewhere though.
...
This is a high variance idea and it pulls ideas from the operation of business, venture capital, and charity. It’s not enough today to just kick some money to the local charity and feel happy. If you’re upper middle class or higher income, that is just table stakes. We need to build more. It takes vision, capital, risk, and effort to change the world.
...
**System:**
- Build a "matchmaking" market for both sides of charity.
- Work with local charities like food banks, battered women shelters, homeless shelters, foster programs, etc. Build a system for those seeking help to describe what transformation of their lives looks like to them. (Per Mauricio Miller, autonomy of their own future is critical)
- This should be individuals or families. It should leverage local charities to get access to these people but not be the local charities.
- Do matchmaking. Allow those providing time/treasure to describe what they're capable of and provide potential matches. Include a random-local match should they just want to have an impact.
- The site itself should allow zero transfer of funds. No money should flow through the site. The actual transition of resources will be intimate and vary. The site is for matchmaking only.
- The site should be incredibly simple on the technology side. I'm thinking of Hacker News which, to this day, runs off 1 VPS and serves millions of requests. The simpler the better to incur minimal expenses.
